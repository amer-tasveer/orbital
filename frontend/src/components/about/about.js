      ...
      <div className="container">
        <div className="about-column">
          <p className="about-text">
            ...
            <br /><br />
            The Southeast Asian independent music scene is like no other. With barely any meddling from large multinational record labels, musicians have been produced with symbiotic ties to other visual creative mediums and their respective subcultures. This is what we hope to explore and archive.
          </p>
          <p className="about-text">
            Orbital will always be ad-free but we need support.<br />
          ...
          <hr className="hr" />
          <h3 className="column-header">Be A Contributor</h3>
          <p className="about-text">
            All content mediums welcome - Sounds, Photography, Articles or Events.<br />
            Get in touch with us.
          </p>
          <hr className="hr" />
          <h3 className="column-header">Staff Writer Wanted</h3>
          <p className="about-text">
        ...
        <div className="team-column">
          <div className="team-container">
            ...
            <p className="team-text">
              After working on a variety of commercial projects including start-ups, Tass decided that he would like to dive into the world of creative media. This new medium, he feels, is needed to balance the humdrum of the concrete world. Thus, this is his dive into the meta.
            </p>
